...
* [Download **AutoXchange**](/download/) (and other converters), install (unzip) AX2022 in **cadviewer/converters/ax/windows** or **cadviewer/converters/ax/linux** or in the designated folder structure.
